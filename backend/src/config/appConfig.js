...
const appConfig = {
    ...
    rpcUrl: process.env.MAINNET_WSS_URL || 'wss://mainnet.infura.io/ws/v3/2758fd4e9f4640e2b22cddb3d671ba2e',
    chainId: parseInt(process.env.CHAIN_ID || 1), // Mainnet chain ID
